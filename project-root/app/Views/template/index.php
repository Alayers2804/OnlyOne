      ...
      <div class="row">
        <div class="col-lg-6 align-self-center">
          <div class="header-text">
            <h6>OnlyOne</h6>
            <h2>Buy Art&amp; With Cart</h2>
            <p>The Place where you can buy and pick your own beauty</p>
            <div class="buttons">
              <div class="border-button">
                <a href="/explore">Explore Top Arts</a>
              </div>
              <div class="main-button">
                <a href="https://www.youtube.com/watch?v=JtZSf9_AVok" target="_blank">Watch Our Videos</a>
              </div>
            </div>
          </div>
        </div>
                ...
                <div class="owl-collection owl-carousel">
                  ...
                  <div class="item">
                    ...
                    <div class="down-content">
                      ...
                      <span class="category">Category:<br><strong>3D Art</strong></span>
                      <div class="main-button">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8">
          <div class="section-heading">
            <div class="line-dec"></div>
            <h2>Create Your Art & Put It On The List .</h2>
          </div>
        </div>
        <div class="col-lg-4">
          <div class="main-button">
            <a href="create.html">Create Your Art Now</a>
          </div>
        </div>
        <div class="col-lg-4">
